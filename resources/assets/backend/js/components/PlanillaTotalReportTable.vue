        ...
        mounted() {
            EventBus.$on('show_table', function(response) {
				...
				Vue.nextTick(function() {
					if ( vm.planilla_total_report_datatable == undefined ) {
						...
						vm.planilla_total_report_datatable.setDataSourceParam('model', vm.model);
						vm.planilla_total_report_datatable.load();
					}
				
					vm.planilla_total_report_datatable.on('kt-datatable--on-ajax-done', function() {
            ...
            EventBus.$on('refresh_table', function() {
                if ( this.planilla_total_report_datatable != undefined ) {
                  this.planilla_total_report_datatable.setDataSourceParam('model', this.model);
        ...
        methods: {
			...
			exportExcel: function() {
                ...
                axios.post(this.url, {
                    ...
                    link.href = url;
                    link.setAttribute('download', 'planilla-septiembre-'+Date.now()+'.xls');
