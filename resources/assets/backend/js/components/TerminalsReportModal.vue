                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="price_mes" id="price_mes" v-model="model.price_mes" @focus="$parent.clearErrorMsg($event)">
								...
								<div class="col-lg-4">    
									<div class="form-group">
										<label class="form-control-label">Fecha de Ingreso a Planta:</label>
										<datetime
											v-model="model.date"
											placeholder="Selecciona una Fecha"
											:format="'dd-LL-yyyy'"
