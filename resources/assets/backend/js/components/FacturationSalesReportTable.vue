...
<script>
    ...
    export default {
        ...
        data() {
            return {
                facturations_sales_report_datatable: undefined,
                show_table: false,
				model: {},
				export: '',
            }
        ...
        mounted() {
            EventBus.$on('show_table', function(response) {
				...
				Vue.nextTick(function() {
					if ( vm.facturations_sales_report_datatable == undefined ) {
						vm.fillTableX();
					} else {
						vm.facturations_sales_report_datatable.setDataSourceParam('model', vm.model);
						vm.facturations_sales_report_datatable.load();
					}
				
					vm.facturations_sales_report_datatable.on('kt-datatable--on-ajax-done', function() {
        ...
        methods: {
            fillTableX: function() {
                ...
                this.facturations_sales_report_datatable = $('.kt-datatable').KTDatatable({
                ...
                this.facturations_sales_report_datatable.columns('id').visible(false);
            },
