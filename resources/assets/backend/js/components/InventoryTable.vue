            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="dropdown dropdown-inline">
                        <a href="#" @click.prevent="createRecord()" class="btn btn-primary" id="createRecord"
                            v-show="flag_create == 1">
                            Crear
                        </a>
                        <a href="#" @click.prevent="addRecord()" class="btn btn-success" id="addRecord"
                            v-show="flag_add == 1">
                            <i class="fa fa-plus"></i> Registro
                        </a>
                        <a href="#" @click.prevent="closeRecord()" class="btn btn-danger" id="closeRecord"
                            v-show="flag_close == 1">
                            <i class="la la-close"></i> Cerrar inventario y cerrar el día
                        </a>
                        <a href="#" @click.prevent="formRecord()" class="btn btn-primary" id="formRecord"
                            v-show="flag_form == 1">
                            <i class="fa fa-file-alt"></i> Imprimir formulario
                        </a>
                        <a href="#" @click.prevent="exportRecord()" class="btn btn-primary" id="exportRecord"
                            v-show="flag_form == 1">
