                ...
                <div class="row">
					...
					<div class="col-lg-3">
                        <div class="form-group">
							...
							<input type="text" class="form-control" name="guide_series" id="guide_series" v-model="model.guide_series" @focus="$parent.clearErrorMsg($event)">
                            <div id="guide_series-error" class="error invalid-feedback"></div>
                        </div>
                    </div>
					<div class="col-lg-3">
                        <div class="form-group">
                            <label class="form-control-label">Nº de Referencia:</label>
							<input type="text" class="form-control" name="guide_number" id="guide_number" v-model="model.guide_number" @focus="$parent.clearErrorMsg($event)">
                            <div id="guide_number-error" class="error invalid-feedback"></div>
                        </div>
                    </div>
                </div>
            </div>
