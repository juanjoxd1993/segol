                ...
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="voucher_type" id="voucher_type" v-model="model.voucher_type"
                                @focus="$parent.clearErrorMsg($event)">
                                <option value="">Selecionar</option>
                                <option v-for="voucher_type in voucher_types" :value="voucher_type.id"
                                    v-bind:key="voucher_type.id">{{ voucher_type.name }}</option>
                            </select>
                    ...
                    <div class="col-lg-2" v-if="model.voucher_type == 2">
                        <div class="form-group">
                            ...
                            <datetime v-model="model.date_of_issue" placeholder="Selecciona una Fecha"
                                :format="'dd-LL-yyyy'" name="date_of_issue" value-zone="America/Lima" class="form-control"
                                @focus="$parent.clearErrorMsg($event)">
                            </datetime>
                            <div id="date_of_issue-error" class="error invalid-feedback"></div>
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="form-group">
                            <label class="form-control-label">Flag Ose:</label>
                            <select class="form-control" name="flag_ose" id="flag_ose" v-model="model.flag_ose"
                                @focus="$parent.clearErrorMsg($event)">
                                <option value="">Seleccionar</option>
                                <option value="0">No enviado</option>
                                <option value="1">Enviado</option>
                            </select>
                            <div id="flag_ose-error" class="error invalid-feedback"></div>
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="form-group">
                            <label class="form-control-label">Serie:</label>
                            <input type="text" class="form-control" name="serie" id="serie" v-model="model.serie"
                                @focus="$parent.clearErrorMsg($event)">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="initial_number" id="initial_number"
                                v-model="model.initial_number" @focus="$parent.clearErrorMsg($event)">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="final_number" id="final_number"
                                v-model="model.final_number" @focus="$parent.clearErrorMsg($event)">
                    ...
                    <div class="col-lg-2" v-if="model.voucher_type == 2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="order_serie" id="order_serie"
                                v-model="model.order_serie" @focus="$parent.clearErrorMsg($event)">
                            <div id="order_serie-error" class="error invalid-feedback"></div>
                        </div>
                    </div>
                    <div class="col-lg-2" v-if="model.voucher_type == 2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="order_number" id="order_number"
                                v-model="model.order_number" @focus="$parent.clearErrorMsg($event)">
