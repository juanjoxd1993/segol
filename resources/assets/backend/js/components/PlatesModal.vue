            ...
            <div class="modal-content">
                ...
                <form class="kt-form" @submit.prevent="formController(url, $event)">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">{{ this.button_text }} Crear Empleado </h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name" placeholder="AAA-000" v-model="model.name" @focus="$parent.clearErrorMsg($event)">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="short_name" id="short_name" placeholder="Código" v-model="model.short_name" @focus="$parent.clearErrorMsg($event)">
                                ...
                                <div class="col-lg-4">
									<div class="form-group">
										<label class="form-control-label">Tipo de Almacén:</label>
										<select class="form-control" name="warehouse_type" id="warehouse_type" v-model="model.warehouse_type" @focus="$parent.clearErrorMsg($event)">
                                            ...
                                            <option value="4">Almacén GLP</option>
