                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="movement_type_id" id="movement_type_id"
                                v-model="model.warehouse_type_index" @focus="$parent.clearErrorMsg($event)">
                                <option selected="true" value="0">Planta Iquitos y Local 1</option>
...
export default {
    ...
    data() {
        return {
            model: {
                initial_date: this.current_date,
