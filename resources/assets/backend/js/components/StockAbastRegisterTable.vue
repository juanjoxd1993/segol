...
<script>
    ...
    export default {
        ...
        methods: {
            openModal: function() {
                EventBus.$emit('stock-abast-register-modal', this.articles, this.igv, this.perception_percentage, this.currency, this.model.movement_class_id, this.model.movement_type_id);
            },
            addArticle: function(model, igv_percentage, perception_percentage) {
                axios.post(this.url_get_article, {
                 ...
                 //   currency: this.currency.id,
                    ...
                    EventBus.$emit('stock_abast_register_modal_hide');
