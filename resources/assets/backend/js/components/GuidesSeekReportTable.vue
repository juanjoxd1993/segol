...
export default {
    ...
    data() {
        return {
            guides_seek_report_datatable: undefined,
            show_table: false,
            model: {},
            export: '',
        }
    ...
    mounted() {
        EventBus.$on('show_table', function (response) {
            ...
            Vue.nextTick(function () {
                if (vm.guides_seek_report_datatable == undefined) {
                    vm.fillTableX();
                } else {
                    vm.guides_seek_report_datatable.setDataSourceParam('model', vm.model);
                    vm.guides_seek_report_datatable.load();
                }

                vm.guides_seek_report_datatable.on('kt-datatable--on-ajax-done', function () {
        ...
        EventBus.$on('refresh_table', function () {
            if (this.guides_seek_report_datatable != undefined) {
                this.guides_seek_report_datatable.setDataSourceParam('model', this.model);
                this.guides_seek_report_datatable.load();
            }
        }.bind(this));
    },
    watch: {
    ...
    methods: {
        fillTableX: function () {
            ...
            this.guides_seek_report_datatable = $('.kt-datatable').KTDatatable({
            ...
            this.guides_seek_report_datatable.columns('id').visible(false);
        },
