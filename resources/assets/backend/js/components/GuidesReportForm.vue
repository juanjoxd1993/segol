            ...
            <div class="kt-portlet__body">
				...
				<div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <select class="form-control kt-select2" name="referral_guide_number" id="referral_guide_number" v-model="model.referral_guide_number" @focus="$parent.clearErrorMsg($event)">
                                <option value="">Seleccionar</option>
                            </select>
                            <div id="creferral_guide_number-error" class="error invalid-feedback"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        methods: {
			newSelect2: function() {
                ...
                $("#referral_guide_number").select2({
                    ...
                    ajax: {
                        url: vm.url_get_warehouse_movements,
                        dataType: 'json',
                        delay: 250,
                        type: 'POST',
                    ...
                    vm.model.referral_guide_number = parseInt(selected_element.val());
                }).on('select2:unselect', function(e) {
                    vm.model.referral_guide_number = '';
                });
            },
