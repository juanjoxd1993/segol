                ...
                <div class="modal-content">
                    ...
                    <div class="kt-form">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Detalle de Movimientos: #{{ title }}</h5>
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align:right;width:110px;"
                                                        v-if="account_type_id == 1">Prestamo</th>
                                                    <th style="text-align:right;width:110px;"
                                                        v-if="account_type_id == 1">Cesión</th>
                                                ...
                                                <tr v-for="(item, index) in articles" v-bind:key="index">
                                                    ...
                                                    <td style="text-align:right;width:110px;">
                                                        <input type="text" class="form-control" name="presale"
                                                            id="presale" v-model="item.presale"
                                                            @focus="$parent.clearErrorMsg($event)">
                                                    </td>
                                                    <td style="text-align:right;width:110px;"
                                                        v-if="account_type_id == 1">
                                                        <input type="text" class="form-control" name="prestamo"
                                                            id="prestamo" v-model="item.prestamo"
                                                            @focus="$parent.clearErrorMsg($event)"
                                                            v-if="item.group_id != 7">
                                                    </td>
                                                    <td style="text-align:right;width:110px;"
                                                        v-if="account_type_id == 1">
                                                        <input type="text" class="form-control" name="cesion"
                                                            id="cesion" v-model="item.cesion"
                                                            @focus="$parent.clearErrorMsg($event)"
                                                            v-if="item.group_id != 7">
                                                    </td>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control kt-select2" name="article-select"
                                                id="article-select" v-model="addArticle.article_id"
                                                @focus="$parent.clearErrorMsg($event)">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="tel" class="form-control" name="quantity" id="quantity"
                                                placeholder="0" v-model="addArticle.quantity"
                                                @focus="$parent.clearErrorMsg($event)">
        ...
        $(document).on('click', '.edit', function () {
            ...
            axios.post(context.url_list, context.$store.state.model)
                .then(response => {
                    ...
                    context.title = data.movement.title;
    ...
    methods: {
        ...
        validate: function () {
            ...
            if (this.ids == '') {
                Swal.fire({
                    title: 'Advertencia!',
                    text: 'Debe seleccionar como mínimo 1 registro',
                    type: "warning",
                    heightAuto: false,
                });
                return;
