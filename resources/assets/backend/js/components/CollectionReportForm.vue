					...
					<div class="col-lg-3">
						<div class="form-group">
							...
							<datetime v-model="model.final_date" placeholder="Selecciona una Fecha"
								...
								zone="America/Lima" class="form-control" :max-datetime="max_datetime"
								@focus="$parent.clearErrorMsg($event)">
							</datetime>
					...
					<div class="col-lg-3">
						<div class="form-group">
							...
							<select class="form-control" name="warehouse_document_type_id"
								id="warehouse_document_type_id" v-model="model.warehouse_document_type_id"
								@focus="$parent.clearErrorMsg($event)">
								<option value="">Seleccionar</option>
								<option v-for="warehouse_document_type in warehouse_document_types"
									:value="warehouse_document_type.id" v-bind:key="warehouse_document_type.id">{{
										warehouse_document_type.name }}</option>
							</select>
					...
					<div class="col-lg-3">
						<div class="form-group">
							...
							<select class="form-control" name="business_unit_id" id="business_unit_id"
								v-model="model.business_unit_id" @focus="$parent.clearErrorMsg($event)">
								<option value="">Seleccionar</option>
								<option v-for="business_unit in business_units" :value="business_unit.id"
									v-bind:key="business_unit.id">{{ business_unit.name }}</option>
							</select>
