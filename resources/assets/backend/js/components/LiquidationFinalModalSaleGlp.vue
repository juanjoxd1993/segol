            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control kt-select2" name="client_id" id="client_id"
                                            v-model="sale.client_id" @focus="$parent.clearErrorMsg($event)">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="warehouse_document_type_id"
                                            id="warehouse_document_type_id" v-model="sale.warehouse_document_type_id"
                                            @focus="$parent.clearErrorMsg($event)">
                                            <option value="">Seleccionar</option>
                                            <option value="5">Factura Electrónica</option>
                                            <option value="31">Boleta de Venta Electrónica</option>
                                        </select>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="sale_serie_num" id="sale_serie_num"
                                            v-model="sale.sale_serie_num" @focus="$parent.clearErrorMsg($event)">
                                            <option value="">Seleccionar</option>
                                            <option v-for="series in sale_series" :value="series.num_serie"
                                                v-bind:key="series.num_serie">{{ series.num_serie }}</option>
                                        </select>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly class="form-control" name="referral_voucher_number"
                                            id="referral_voucher_number" v-model="sale.referral_voucher_number"
                                            @focus="$parent.clearErrorMsg($event)">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <datetime v-model="sale.sale_date" placeholder="Selecciona una Fecha"
                                            :format="'dd-LL-yyyy'" input-id="final_effective_date"
                                            name="final_effective_date" value-zone="America/Lima" zone="America/Lima"
                                            class="form-control" @focus="$parent.clearErrorMsg($event)">
                                        </datetime>
                                        <div id="sale_date-error" class="error invalid-feedback"></div>
                                    </div>
                                </div>
                                <div class="col-lg-3" v-if="this.sale.warehouse_document_type_id == 5">
                                    <div class="form-group">
                                        <label class="form-control-label">Serie de Guía:</label>
                                        <input type="text" class="form-control" name="referral_guide_series"
                                            id="referral_guide_series" v-model="sale.referral_guide_series"
                                            @focus="$parent.clearErrorMsg($event)">
                                ...
                                <div class="col-lg-3" v-if="this.sale.warehouse_document_type_id == 5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="referral_guide_number"
                                            id="referral_guide_number" v-model="sale.referral_guide_number"
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="currency_id" id="currency_id"
                                            v-model="sale.currency_id" @focus="$parent.clearErrorMsg($event)">
                                            <option value="">Seleccionar</option>
                                            <option v-for="currency in currencies" :value="currency.id"
                                                v-bind:key="currency.id">{{ currency.name }}</option>
                                        </select>
                                ...
                                <div class="col-lg-3" v-if="this.sale.warehouse_document_type_id == 5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" v-model="sale.scop_number"
                                            name="scop_number" id="scop_number" @focus="$parent.clearErrorMsg($event)"
                                            v-on:change="manageScopNumber">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="article_id" id="article_id"
                                            v-model="model.article_id" @change="getArticlePrice()"
                                            @focus="$parent.clearErrorMsg($event)">
                                            <option value="">Seleccionar</option>
                                            <option v-for="article in filterArticles" :value="article.id"
                                                v-bind:key="article.id">{{ article.name }} - {{ article.stock_good }}
                                            </option>
                                        </select>
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="quantity" id="quantity"
                                            v-model="model.quantity" @focus="$parent.clearErrorMsg($event)">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-success"
                                            @click.prevent="addArticle()">Agregar</button>
                                    ...
                                    <table class="table table-vertical-middle">
                                        ...
                                        <tbody>
                                            <tr v-for="(item, index) in setDetails" v-bind:key="index">
                                                ...
                                                <td style="text-align:right;width:110px;">{{ item.total_perception }}
                                                </td>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td style="text-align:right;width:110px;font-weight:600;"></td>
                                                <td style="text-align:right;width:110px;font-weight:600;">{{ sale.total
                                                    }}</td>
                                                <td style="text-align:right;width:110px;font-weight:600;">{{
                                                    sale.perception }}</td>
                                                <td style="text-align:right;width:110px;font-weight:600;">{{
                                                    sale.total_perception }}</td>
                    ...
                    <div class="modal-footer">
                        <button id="liquidar" type="submit" class="btn btn-success"
                            @click.prevent="liquidationModal()">Liquidar</button>
...
export default {
    ...
    watch: {
        'sale.warehouse_document_type_id': function (val) {
            ...
            if (val != '') {
                ...
                axios.post(this.url_get_series, {
                    ...
                    this.sale_series = '';
                    this.sale_series = response.data;
        ...
        'sale.sale_serie_num': function (val) {
            let serie = this.sale_series.find(element => element.num_serie == val);
            this.sale.referral_voucher_number = serie ? serie.correlative : '';
        }
    },
    computed: {
        setDetails() {
    ...
    methods: {
        ...
        addArticle: function () {
            ...
            if (this.sale.client_id == '') {
            ...
            } else if (this.model.quantity > Number(article.stock_good)) {
                Swal.fire({
                    title: '¡Error!',
                    text: 'La Cantidad supera el Saldo del Artículo (' + article.stock_good + ').',
                    type: "error",
                    heightAuto: false,
                    showCancelButton: false,
                    confirmButtonText: 'Ok',
                ...
                article.stock_good = article.stock_good - this.model.quantity;

                console.log(this.$store.state.articles);

                model.article_name = article.name;
        ...
        removeArticle: function (index) {
            ...
            let $obj = this.sale.details[index];
            let article = this.$store.state.articles.find(element => element.id == $obj.article_id)

            if ($obj && $obj.quantity) {
                article.stock_good = article.stock_good + Number($obj.quantity);
            }
