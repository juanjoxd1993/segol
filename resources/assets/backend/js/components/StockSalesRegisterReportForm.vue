                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <select class="form-control kt-select2" name="warehouse_movement_id" id="warehouse_movement_id" v-model="model.warehouse_movement_id" @focus="$parent.clearErrorMsg($event)">
                                <option value="">Seleccionar</option>
                            </select>
        ...
        watch: {
            'model.company_id': function(val, old) {
				if ( val != old ) {
					...
					$('#warehouse_movement_id').val(null).trigger('change');
				}
			}
        },
        computed: {
        ...
        methods: {
			newSelect2: function() {
                ...
                $("#warehouse_movement_id").select2({
                    ...
                    vm.model.warehouse_movement_id = parseInt(selected_element.val());
                }).on('select2:unselect', function(e) {
                    vm.model.warehouse_movement_id = '';
                });
            },
