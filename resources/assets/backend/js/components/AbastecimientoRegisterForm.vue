                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <datetime v-model="model.since_date" placeholder="Selecciona una Fecha"
                                ...
                                zone="America/Lima" class="form-control" :min-datetime="this.max_datetime" :max-datetime="this.max_datetime"
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <datetime v-model="model.traslate_date" placeholder="Selecciona una Fecha"
                                ...
                                :min-datetime="this.max_datetime" :max-datetime="this.max_datetime_ingreso" @focus="$parent.clearErrorMsg($event)">
                            </datetime>
...
export default {
    ...
    created() {
        EventBus.$on('reset_abastecimiento_register', function () {
