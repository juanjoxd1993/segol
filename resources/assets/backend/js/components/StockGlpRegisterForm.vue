                ...
                <div class="row">
                    ...
                    <div v-bind:class="'col-lg-3' + (' d-none')">
                        <div class="form-group">
                            ...
                            <select class="form-control readonly" name="movement_type_id" id="movement_type_id"
                                ...
                                <option selected value="30">Abastecimiento Punto Gas</option>
                            </select>
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="warehouse_type_id" id="warehouse_type_id"
                                ...
                                <option v-for="warehouseType in warehouse_providers" :value="warehouseType.id"
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="invoice" id="invoice" v-model="model.invoice"
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <select class="form-control kt-select2" name="warehouse_account_id"
                                id="warehouse_account_id" v-model="model.warehouse_account_id"
                                @focus="$parent.clearErrorMsg($event)">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="referral_guide_series"
                                id="referral_guide_series" v-model="model.referral_guide_series"
                                @focus="$parent.clearErrorMsg($event)">
                    ...
                    <div v-bind:class="'col-lg-3' + (model.movement_type_id != 30 ? '' : ' d-none')">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="referral_serie_number"
                                id="referral_serie_number" v-model="model.referral_serie_number"
                                @focus="$parent.clearErrorMsg($event)">
                    ...
                    <div v-bind:class="'col-lg-3' + (model.movement_type_id != 30 ? '' : ' d-none')">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="referral_voucher_number"
                                id="referral_voucher_number" v-model="model.referral_voucher_number"
                                @focus="$parent.clearErrorMsg($event)">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="license_plate_2" id="license_plate_2"
                                v-model="model.license_plate_2" @focus="$parent.clearErrorMsg($event)">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="price_mes" id="price_mes" v-model="model.price_mes"
                                @focus="$parent.clearErrorMsg($event)">
                                <option disabled value="">Seleccionar</option>
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="mezcla" id="mezcla" v-model="model.mezcla"
                                @focus="$parent.clearErrorMsg($event)">
                                <option disabled value="">Seleccionar</option>
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="isla" id="isla" v-model="model.isla"
                                @focus="$parent.clearErrorMsg($event)">
    ...
    watch: {
        'model.warehouse_type_id': function (val) {
            ...
            axios.post(this.url_get_invoices, {
                ...
                this.model.invoice = response.data;
            }).catch(error => {
                EventBus.$emit('loading', false);
                console.log(error);
            });
