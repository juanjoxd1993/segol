...
export default {
    ...
    methods: {
        openModal: function () {
            EventBus.$emit('abastecimiento-register-modal', this.articles, this.igv, this.perception_percentage, this.currency, this.model.movement_class_id, this.model.movement_type_id);
        },
        addArticle: function (model, igv_percentage, perception_percentage) {
            axios.post(this.url_get_article, {
                ...
                EventBus.$emit('abastecimiento_register_modal_hide');
            ...
            if (this.article_list != '' && this.article_list != []) {
                ...
                axios.post(this.url, {
                    ...
                    Swal.fire({
                        ...
                        window.location = '/operaciones/registro-abas-planta';
                    })
                }).catch(error => {
                    EventBus.$emit('loading', false);
                    console.log(error);
