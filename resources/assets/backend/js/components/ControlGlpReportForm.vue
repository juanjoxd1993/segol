                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <datetime v-model="model.initial_date" placeholder="Selecciona una Fecha inicial"
                                :format="'dd-LL-yyyy'" input-id="initial_date" name="initial_date" value-zone="America/Lima"
                                zone="America/Lima" class="form-control" :max-datetime="current_date"
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <datetime v-model="model.final_date" placeholder="Selecciona una Fecha final"
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="warehouse_type" id="warehouse_type"
                                v-model="model.warehouse_type" @focus="$parent.clearErrorMsg($event)">
                                <option value="">Seleccionar</option>
                                <option value="1">Provedores</option>
                    ...
                    <div class="col-lg-3" v-if="model.warehouse_type == 5">
                        <div class="form-group">
