                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="bussiness_unit_id" id="bussiness_unit_id" v-model="model.bussiness_unit_id" @focus="$parent.clearErrorMsg($event)">
...
<script>
    ...
    export default {
        ...
        watch: {
            'model.bussiness_unit_id': function(val, old) {
				if ( val != old ) {
