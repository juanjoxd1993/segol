...
<script>
    ...
    export default {
        ...
        created() {
            EventBus.$on('stock_register_modal', function(articles, igv, perception_percentage, currency, movement_class_id, movement_type_id) {
            ...
            EventBus.$on('stock_register_modal_hide', function() {
