...
<script>
    ...
    export default {
        ...
        data() {
            return {
                masa_report_datatable: undefined,
                show_table: false,
				model: {},
				export: '',
            }
        ...
        mounted() {
            EventBus.$on('show_table', function(response) {
				...
				Vue.nextTick(function() {
					if ( vm.masa_report_datatable == undefined ) {
						vm.fillTableX();
					} else {
            ...
            EventBus.$on('refresh_table', function() {
                if ( this.masa_report_datatable != undefined ) {
                  this.masa_report_datatable.setDataSourceParam('model', this.model);
                   this.masa_report_datatable.load();
               }
            }.bind(this));
        },
        watch: {
        ...
        methods: {
            fillTableX: function() {
                ...
                this.masa_report_datatable = $('.kt-datatable').KTDatatable({
                ...
                this.masa_report_datatable.columns('id').visible(false);
            },
