                            ...
                            <div class="row">
								...
								<div class="col-lg-4">
									<div class="form-group">
										<label class="form-control-label">Stock de Retorno:</label>
										<input type="text" class="form-control" name="new_stock_return" id="new_stock_return" v-model="model.new_stock_return" @focus="$parent.clearErrorMsg($event)">
										<div id="new_stock_return-error" class="error invalid-feedback"></div>
									</div>
								</div>
                                
                                <div class="col-lg-4">
									<div class="form-group">
										<label class="form-control-label">Stock de Salida:</label>
