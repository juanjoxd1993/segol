                ...
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="flag_ose" id="flag_ose" v-model="model.flag_ose" @focus="$parent.clearErrorMsg($event)">
                                <option value="">Seleccionar</option>
                    ...
                    <div class="col-lg-2" v-if="model.voucher_type == 2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="order_serie" id="order_serie" v-model="model.order_serie" @focus="$parent.clearErrorMsg($event)">
