            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="dropdown dropdown-inline">
                        ...
                        <a href="#" @click.prevent="sendVouchers('pdf')" class="btn btn-outline-brand btn-bold btn-sm" v-if="user_name === 'admin' || user_name === 'facturacion1' || user_name === 'facturacion2' || user_name === 'contabilidad1' || user_name === 'sistemas1' || user_name === 'finanzas1' || user_name === 'finanzas2'">
						...
						<a href="#" @click.prevent="sendVouchers('resumen')" class="btn btn-outline-brand btn-bold btn-sm" v-if="model.voucher_type == 2 && ( user_name === 'admin' || user_name === 'facturacion1' || user_name === 'facturacion2' || user_name === 'contabilidad1' || user_name === 'sistemas1' || user_name === 'finanzas1' || user_name === 'finanzas2' )">
                            <i class="fa fa-file"></i> Resumen
                        </a>
						<a href="#" @click.prevent="sendVouchers('baja')" class="btn btn-outline-brand btn-bold btn-sm" v-if="model.flag_ose == 1 && ( user_name === 'admin' || user_name === 'facturacion1' || user_name === 'facturacion2' || user_name === 'contabilidad1' || user_name === 'sistemas1' || user_name === 'finanzas1' || user_name === 'finanzas2' )">
