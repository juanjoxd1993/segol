                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="warehouse_type_id" id="warehouse_type_id" v-model="model.warehouse_type_id" @focus="$parent.clearErrorMsg($event)" @change="warehouseChange()">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="warehouse_account_type_id" id="warehouse_account_type_id" v-model="model.warehouse_account_type_id" @focus="$parent.clearErrorMsg($event)" @change="warehouseAccountTypesChange()">
                                <option value="">Seleccionar</option>
                                <option v-for="warehouse_account_type in warehouse_account_types" :value="warehouse_account_type.id" v-bind:key="warehouse_account_type.id">{{ warehouse_account_type.name }}</option>
                            </select>
