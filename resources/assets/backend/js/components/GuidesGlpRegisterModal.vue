<template>
    <!--begin::Modal-->
    <div class="modal fade" id="guides-glp-register-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <div class="kt-portlet__body">
                            <div class="row">
                                ...
                                <div class="col-lg-3" >
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="tel" class="form-control" name="total" id="total" placeholder="0" v-model="model.total" @focus="$parent.clearErrorMsg($event)">
                                        </div>
                                 ...
                                 <div class="col" >
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input disabled class="form-control" name="price" id="price" placeholder="0" v-model="model.price" @focus="$parent.clearErrorMsg($event)">
                                        </div>
                                ...
                                <div class="col" >
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="tel" class="form-control" name="sale_value" id="sale_value" placeholder="0" v-model="getValue" @focus="$parent.clearErrorMsg($event)">
                                        </div>
                                ...
                                <div class="col" v-if="perception_flag == 1 ">
                                    <div class="form-group">
    ...
    export default {
        ...
        watch: {
            'model.quantity': function(val) {
                this.model.price = (this.model.total/val).toFixed(4);
            ...
            'model.total': function(val) {
                this.model.price = (val/this.model.quantity).toFixed(4);
            },
        ...
        created() {
            EventBus.$on('guides-glp-register-modal', function(articles, igv, perception_percentage, currency, movement_class_id, movement_type_id) {
                ...
                $('#guides-glp-register-modal').modal('show');
            }.bind(this));

            EventBus.$on('guides-glp-register-modal_hide', function() {
                ...
                $('#guides-glp-register-modal').modal('hide');
                // document.getElementById('add_article_2').disabled = false;
            }.bind(this));
        ...
        mounted() {
            ...
            $('#guides-glp-register-modal').on('hide.bs.modal', function(e) {
                this.model.article_id = '';
                this.model.quantity = '';
                this.model.price = '';
                this.model.sale_value = '';
