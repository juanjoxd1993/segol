...
@if ( Route::currentRouteName() === 'dashboard.report.stock_seek_register' )
...
@section('content')
	<stock-seek-register-report-form
		...
		:url = "'{{ route('dashboard.report.stock_seek_register.validate_form') }}'"
		
	></stock-seek-register-report-form>

	@if ( Route::currentRouteName() === 'dashboard.report.stock_seek_register' )
		<stock-seek-register-report-table
			:url = "'{{ route('dashboard.report.stock_seek_register.list') }}'"
			:url_detail = "'{{ route('dashboard.report.stock_seek_register.detail') }}'"
		></stock-seek-register-report-table>
	@endif
	...
	<stock-seek-register-report-modal
		:url = "'{{ route('dashboard.report.stock_seek_register.update') }}'"
	></stock-seek-register-report-modal>
