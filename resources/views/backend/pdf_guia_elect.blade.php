...
<body>
    <div id="pdf">
        <table class="pdf-head" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td>
                    <div class="logo">
                        @if ( $obj->company_id == 2 )
                        <img src="{{ public_path('backend/img/punto_gas_logo.jpeg') }}" alt="">
                        @endif
                    </div>
                    <div class="info">
                ...
                <td>
                    <div class="voucher-data">
                        ...
                        <p class="voucher-type">Guía {{ $obj->nom_guia }}</p>
            ...
            <tr>
                <td style="vertical-align:top;">
                    <div class="subhead-obj">
                        ...
                        <div class="subhead-text">{{ $obj->cliente }}</div>
                    </div>
                </td>
                <td style="vertical-align:top;">
                    <div class="subhead-obj">
                        <div class="subhead-title">{{ $obj->tipo_doc_client }}</div>
                    ...
                    <td>
                        <table class="pdf-total-text" cellspacing="0" cellpadding="0" border="0">
                            ...
                            <tr>
                                <td>
                                    <div class="total-text-item">
                                        <div class="total-text-title">Peso Bruto (Kg)</div>
                                        <div class="total-text-text">{{ $obj->kg }}</div>
                                    </div>
                                </td>
        ...
        <div>
            <div class="qr">
                <img src="data:image/png;base64, {{ $document_qrcode }}"><br>
                Código QR
            </div>
        </div>
