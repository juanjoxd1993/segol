...
<cbc:IssueDate>{{ $obj->issue_date }}</cbc:IssueDate>
<cbc:DocumentTypeCode listAgencyName="PE:SUNAT" listName="{{ $obj->warehouse_document_types_name }}" listURI="urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo01">01</cbc:DocumentTypeCode>
</cac:InvoiceDocumentReference>
