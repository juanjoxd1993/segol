...
<html lang="es">
	...
	<head>
		...
		<link rel="icon" href="<?php echo e(asset('frontend/img/favicon.png')); ?>">
	</head>
	<!-- end::Head -->
							...
							<div class="kt-login__container">
								<div class="kt-login__body">
									<div class="kt-login__logo">
										<a href="#">
											<img src="<?php echo e(asset('backend/img/logo-login.png')); ?>">
										</a>
									</div>
	...
	<!-- end::Global Config -->
</html><?php /**PATH D:\www\pdd\resources\views/backend/login.blade.php ENDPATH**/ ?>