				...
				<td>
					<table cellspacing="0" cellpadding="0" border="0" style="width:100%;">
						<tr>
							...
							<td style="width:2.5cm;height:0.4cm;vertical-align:middle;"><?php echo e($warehouse_movement->creation_date); ?></td>
							<td style="width:1.9cm;"> </td>
							<td style="width:2cm;height:0.4cm;vertical-align:middle;"><?php echo e($warehouse_movement->traslate_date); ?></td>
							<td></td>
						</tr>
					</table>
				</td>
										...
										<td>
											<table cellspacing="0" cellpadding="0" border="0" style="width:100%;">
												<tr>
													...
													<td style="width:3.6cm;height:0.5cm;vertical-align:top;"><?php echo e($warehouse_movement->account_name); ?></td>
												</tr>
											</table>
										</td>
									</tr>
										...
										<td>
											<table cellspacing="0" cellpadding="0" border="0" style="width:100%;">
												<tr>
													...
													<td style="width:5.53cm;height:0.2cm;vertical-align:middle;"><?php echo e($warehouse_movement->account_document_number); ?></td>
												</tr>
											</table>
										</td>
									</tr>
										...
										<td>
											<table cellspacing="0" cellpadding="0" border="0" style="width:100%;">
												<tr>
													...
													<td style="width:3.8cm;height:0.2cm;vertical-align:top;"><?php echo e($warehouse_movement->license_plate); ?></td>
													<td> </td>
												</tr>
											</table>
										</td>
										...
										<td>
											<table cellspacing="0" cellpadding="0" border="0" style="width:100%;">
												<tr>
													...
													<td style="width:4.0cm;height:0.2cm;vertical-align:middle;"><?php echo e($warehouse_movement->employee_license); ?></td>
													<td> </td>
												</tr>
											</table>
										</td>
										...
										<td>
											<table cellspacing="0" cellpadding="0" border="0" style="width:100%;">
												<tr>
													...
													<td style="width:6.3cm;height:0.2cm;vertical-align:top;"><?php echo e($warehouse_movement->company_address); ?></td>
												</tr>
											</table>
										</td>
									</tr>
													...
													<td style="width:2.7cm;vertical-align:top;">
														<table cellspacing="0" cellpadding="0" border="0" style="width:100%;">
															<tr>
																...
																<td style="width:1.7cm;height:0.2cm;vertical-align:middle;text-transform:uppercase;"><?php echo e($warehouse_movement->company_district); ?></td>
															</tr>
														</table>
													</td>
													<td style="width:2.3cm;vertical-align:top;">
														<table cellspacing="0" cellpadding="0" border="0" style="width:100%;">
															<tr>
																...
																<td style="width:1.7cm;height:0.2cm;vertical-align:middle;text-transform:uppercase;"><?php echo e($warehouse_movement->company_province); ?></td>
															</tr>
														</table>
													</td>
													<td style="vertical-align:top;">
														<table cellspacing="0" cellpadding="0" border="0" style="width:100%;">
															<tr>
																<td style="width:0.5cm;"> </td>
																<td style="width:1.3cm;height:0.2cm;vertical-align:middle;text-transform:uppercase;"><?php echo e($warehouse_movement->company_department); ?></td>
																<td> </td>
															</tr>
														</table>
													</td>
				...
				<td style="height:2.65cm;vertical-align:top;">
					<table cellspacing="0" cellpadding="0" border="0" style="width:100%;table-layout:auto;">
						<tr>
							...
							<td style="width:6.65cm;vertical-align:top;">
								<table cellspacing="0" cellpadding="0" border="0" style="width:100%;table-layout:auto;">
									<?php $__currentLoopData = $packaging; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<tr>
											...
											<td style="width:0.06cm;"> </td>
											<td style="width:1.75cm;vertical-align:top;">
												<?php echo e($package->classification_name); ?>

											</td>
											<td style="width:0.08cm;"> </td>
											<td style="width:1.1cm;vertical-align:top;text-align:right;">
												<?php echo e($package->total_converted_amount); ?>
...
<?php /**PATH /var/www/pdd/resources/views/backend/pdf/referral_guide2.blade.php ENDPATH**/ ?>