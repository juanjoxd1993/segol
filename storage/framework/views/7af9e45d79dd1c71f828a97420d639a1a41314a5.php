...
<html lang="es">
	...
	<head>
		...
		<link href="<?php echo e(asset('backend/css/custom.css')); ?>" rel="stylesheet" type="text/css" />
	...
	<!-- begin::Body -->
	<body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading <?php echo $__env->yieldContent('body-class'); ?>">
		<main id="app">
			<!-- begin:: Page -->
			<!-- begin:: Header Mobile -->
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
					...
					<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
						...
						<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
							<?php echo $__env->make('backend.includes.title', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	...
	<!-- end::Body -->
</html><?php /**PATH /var/www/pdd/resources/views/backend/templates/app.blade.php ENDPATH**/ ?>