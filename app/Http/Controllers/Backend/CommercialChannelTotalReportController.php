...
class CommercialChannelTotalReportController extends Controller
{
    public function index() {
		$business_units = BusinessUnit::select('id', 'name')->get();
		$current_date =CarbonImmutable::now()->toAtomString();
		return view('backend.commercial_channel_total_report')->with(compact('business_units', 'current_date'));
	}
