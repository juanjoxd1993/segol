...
class StockFinalReportController extends Controller
{
	...
	public function detail() {
     $id = request('id');
     $element = WarehouseMovementDetail::select('id', 'new_stock_return','converted_amount')
	 ->findOrFail($id);
