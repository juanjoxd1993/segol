...
class StockAbastRegisterController extends Controller
{
    public function index() {
		...
		$warehouse_receivers = WarehouseType::select('id', 'name')->where('type', 3)->get();

		return view('backend.stock_abast_register')->with(compact('movement_classes', 'movement_types', 'movement_stock_types', 'warehouse_types', 'companies', 'currencies', 'current_date', 'min_datetime', 'max_datetime', 'warehouse_account_types', 'warehouse_document_types', 'igv', 'warehouse_providers', 'warehouse_receivers'));
	}
