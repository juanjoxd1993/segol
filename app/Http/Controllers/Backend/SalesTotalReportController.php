...
class SalesTotalReportController extends Controller
{
    public function index() {
		$business_units = BusinessUnit::select('id', 'name')->get();
		$current_date = date(DATE_ATOM, mktime(0, 0, 0));
		return view('backend.sales_total_report')->with(compact( 'current_date'));
	}
	...
	public function list() {
		...
		$elements = Sales::leftjoin('sale_details', 'sales.id', '=', 'sale_details.sale_id')
