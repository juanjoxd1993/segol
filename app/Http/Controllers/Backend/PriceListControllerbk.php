...
class PriceListController extends Controller
{
    public function index() {
        ...
        return view('backend.price_list')->with(compact('companies', 'articles'));
    }
    ...
    public function list() {
        ...
        $elements = PriceList::join('clients', 'price_lists.client_id', '=', 'clients.id')
            ->select('price_lists.id', 'client_id', 'warehouse_type_id', 'article_id', 'price_igv', 'initial_effective_date', 'final_effective_date', 'state', 'business_name')
    ...
    public function store() {
        ...
        foreach ($ids as $id) {
            ...
            if ( $element ) {
                $element->final_effective_date = $yesterday;
