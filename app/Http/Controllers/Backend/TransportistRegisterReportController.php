...
class TransportistRegisterReportController extends Controller
{
	public function index() {
		...
		return view('backend.transportist_register_report')->with(compact('movement_classes', 'movement_types', 'warehouse_types', 'companies', 'current_date', 'warehouse_account_types', 'warehouse_document_types'));
	}
