...
class StockPruebaReportController extends Controller
{
	public function index() {
		...
		return view('backend.stock_prueba_report')->with(compact('movement_classes', 'movement_types', 'warehouse_types', 'companies', 'current_date', 'warehouse_account_types', 'warehouse_document_types'));
	}
	...
	public function detail() {
     $id = request('id');
     $element = WarehouseMovement::leftjoin('warehouse_movement_details', 'warehouse_movement_details.warehouse_movement_id', '=', 'warehouse_movement_details.id')
	 ->select('warehouse_movement_details.id','warehouse_movement_details.converted_amount as converted_amount', 'warehouse_movement_details.new_stock_return as new_stock_return');
