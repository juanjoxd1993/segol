...
class StockRegisterBetaController extends Controller
{
    public function index() {
		...
		return view('backend.stock_register_beta')->with(compact('movement_classes', 'movement_types', 'movement_stock_types', 'warehouse_types', 'companies', 'currencies', 'current_date', 'min_datetime', 'max_datetime', 'warehouse_account_types', 'warehouse_document_types', 'igv','client_routes','guide_series'));
	}
