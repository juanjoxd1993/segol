...
class ClientController extends Controller
{
	public function index() {
		...
		return view('backend.clients')->with(compact('companies', 'document_types', 'payments', 'perceptions', 'address_types', 'business_units', 'client_zones', 'client_channels', 'client_routes', 'client_sectors'));
	}
	...
	public function list() {
		...
		$elements = Client::select('id', 'company_id', 'code', 'business_name', 'document_type_id', 'document_number', 'email', 'phone_number_1', 'phone_number_2', 'seller_id', 'credit_limit', 'perception_percentage_id', 'zone_id', 'channel_id', 'route_id', 'sector_id')
			->where('company_id', $company_id)
			->when($search, function($query, $search) {
				return $query->where('business_name', 'like', '%'.$search.'%')->orWhere('document_number', 'like', '%'.$search.'%');
			})
	...
	public function detail() {
		...
		$element = Client::select('id', 'company_id', 'code', 'business_name', 'document_type_id', 'document_number', 'contact_name_1', 'contact_name_2', 'email', 'phone_number_1', 'phone_number_2', 'phone_number_3', 'link_client_id', 'seller_id', 'business_type', 'payment_id', 'credit_limit', 'credit_limit_days', 'perception_percentage_id', 'business_unit_id', 'zone_id', 'channel_id', 'route_id', 'sector_id')->findOrFail($id);
