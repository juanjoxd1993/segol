...
class TerminalsReportController extends Controller
{
	public function index() {
		...
		return view('backend.terminals_report')->with(compact('movement_classes', 'movement_types', 'warehouse_types', 'companies', 'current_date', 'warehouse_account_types', 'warehouse_document_types'));
	}
	...
	public function detail() {
		...
		$element = WarehouseMovement::select('id','created_at','movement_type_id', 'account_id', 'referral_guide_series', 'referral_guide_number', 'referral_serie_number', 'referral_voucher_number', 'scop_number','license_plate_2', 'license_plate', 'traslate_date','price_mes')
			->findOrFail($id);
