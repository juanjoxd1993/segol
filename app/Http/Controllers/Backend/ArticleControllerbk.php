...
class ArticleController extends Controller
{
	public function index() {
		...
		return view('backend.articles')->with(compact('warehouse_types', 'families', 'groups', 'subgroups', 'operations', 'units'));
	}
	...
	public function detail() {
		...
		$article = Article::select('id', 'warehouse_type_id', 'code', 'name', 'package_sale', 'sale_unit_id', 'package_warehouse', 'warehouse_unit_id', 'operation_type_id', 'factor', 'family_id', 'group_id', 'subgroup_id', 'igv', 'perception', 'stock_minimum', 'ubication')->findOrFail($id);
		return $article;
	}
	...
	public function exportRecord() {
		...
		$elements = Article::join('units as sale_units', 'sale_units.id', '=', 'sale_unit_id')
			...
			->select('articles.id', 'code as article_code', 'articles.name as article_name', 'sale_units.name as sale_unit_name', 'warehouse_units.name as warehouse_unit_name', 'package_sale', 'package_warehouse', 'families.name as family_name', 'groups.name as group_name', 'subgroups.name as subgroup_name', 'stock_good', 'stock_repair', 'stock_return', 'stock_damaged', 'ubication')
		...
		$excel = new ArticleReportExport($warehouse_type_name, $datetime, $elements);
